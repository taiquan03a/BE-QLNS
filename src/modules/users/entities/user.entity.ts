...
import { Column, Entity, JoinTable, ManyToMany, OneToMany, OneToOne, PrimaryGeneratedColumn, Table } from "typeorm";
...
export class User {
    ...
    // @OneToMany(() => ProfileRequest, (profileRequest) => profileRequest.user)
